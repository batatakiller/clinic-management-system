...
function LoginFormContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLocalError("");
    if (!formData.email) { setLocalError("O e-mail é obrigatório"); return; }
    if (!formData.password) { setLocalError("A senha é obrigatória"); return; }
    ...
    <div className="w-full max-w-[420px]">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm">
          Faça login na sua conta do HealthCare MS para continuar.
        </p>
      </div>
